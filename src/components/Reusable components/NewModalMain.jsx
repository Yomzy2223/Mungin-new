        ...
        <div className="w-[500px] h-[500px] bg-white rounded-xl p-6">
          ...
          <div className="m-2 flex flex-col space-y-3 mt-8">
            ...
            <div className="text-left w-full space-y-2 border-b">
              <p className="text-[#313131] text-xl font-semibold">
                Analyze crop yield
              </p>
              <p className="pb-6 text-[#5A5A5A] text-sm">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  className="border w-full text-[#5A5A5A] py-3 text-xs pl-4 rounded-md"
              ...
              <div className="pt-5">
                <button
                  onClick={() => setnewModalMain(true)}
                  className="bg-[#17233C] w-full flex justify-center text-center text-white py-3 px-4 rounded-sm"
                >
                  Analyze Crop Yield
                </button>
              </div>
