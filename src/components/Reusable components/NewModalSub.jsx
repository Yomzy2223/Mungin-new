      ...
      <div className="w-[500px] h-[600px] mb-32 bg-white rounded-xl p-6">
        ...
        <div className="m-2 flex flex-col space-y-3 mt-8">
          ...
          <div className="text-left w-full space-y-2 border-b">
            <p className="text-[#313131] text-xl font-semibold pb-6">
              Analyze Crop Yield
            </p>
          </div>
          ...
          <div className="space-y-6 pt-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[#5A5A5A] text-xs">
                Recommendation: (Loamy Soil) Apply organic fertilizer, plant
                cover crop like cowpea, practice mulching.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-[#5A5A5A] text-xs">
                Recommendation: (400mm/annum) You have a 100mm deficit. Practice
                irrigation, plant cover crops or mulching.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-[#5A5A5A] text-xs">
                Recommendation: (4.5) Your soil acidity is high, apply potash
                and reduce inorganic fertilizer.
              </p>
            </div>
          </div>
        </div>
